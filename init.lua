...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'tsx', 'yaml', 'html', 'javascript', 'typescript', 'vimdoc', 'vim', 'prisma', 'xml', 'sql', 'css', 'scss', 'json' },
...
-- Setup lspconfig for typescript and react autocompletion
local lspconfig = require('lspconfig')

-- Enable LSP for JavaScript, TypeScript, and React.
lspconfig.tsserver.setup {
  -- Your setup options here (e.g., on_attach, filetypes).
...
vim.cmd('autocmd FileType javascript setlocal omnifunc=v:lua.vim.lsp.omnifunc')
